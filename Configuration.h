...
#define STRING_CONFIG_H_AUTHOR "Ignatius Reilly" // Who made the changes.
...
#define DEFAULT_MAX_ACCELERATION      {2000,2000,100,8000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
